...
const MASTER = {
  name: 'Анна Смирнова',
  emoji: '💅',                              // Эмодзи-аватар
  specialty: 'Nail-мастер · Москва',
  bio: 'Мастер маникюра и педикюра с 7-летним опытом. Специализируюсь на долговечном покрытии, уходовых процедурах и дизайне ногтей. Работаю только с профессиональными материалами.',
  experience: '7 лет',
  clients: '500+',
  rating: '4.9',
